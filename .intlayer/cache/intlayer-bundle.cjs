...
var O = Object.create,
  ...
  S = (t, u, c, d) => {
    if ((u && typeof u == 'object') || typeof u == 'function')
      for (var p = L(u), g = 0, P = p.length, l; g < P; g++)
        ((l = p[g]),
          !s.call(t, l) &&
            l !== c &&
            m(t, l, {
              get: ((y) => u[y]).bind(null, l),
              enumerable: !(d = j(u, l)) || d.enumerable,
            }))
    return t
  },
  b = (t, u, c) => (
    ...
    S(
      u || !t || !t.__esModule
        ? m(c, 'default', { value: t, enumerable: !0 })
        : c,
      t,
    )
  ),
  v = require('E:\\NeilRomblon\\Projects\\neon-xr-posthoc-player\\node_modules\\@intlayer\\types\\dist\\cjs\\allLocales.cjs'),
  f = require('E:\\NeilRomblon\\Projects\\neon-xr-posthoc-player\\node_modules\\@intlayer\\types\\dist\\cjs\\locales.cjs')
f = b(f)
var o = require('E:\\NeilRomblon\\Projects\\neon-xr-posthoc-player\\.intlayer\\config\\configuration.cjs')
o = b(o)
var C = require('E:\\NeilRomblon\\Projects\\neon-xr-posthoc-player\\node_modules\\@intlayer\\core\\dist\\cjs\\transpiler\\file\\file.cjs'),
  a = require('E:\\NeilRomblon\\Projects\\neon-xr-posthoc-player\\node_modules\\@intlayer\\core\\dist\\cjs\\formatters\\index.cjs'),
  i = require('E:\\NeilRomblon\\Projects\\neon-xr-posthoc-player\\node_modules\\@intlayer\\core\\dist\\cjs\\interpreter\\index.cjs'),
  e = require('E:\\NeilRomblon\\Projects\\neon-xr-posthoc-player\\node_modules\\@intlayer\\core\\dist\\cjs\\localization\\index.cjs'),
  M = require('E:\\NeilRomblon\\Projects\\neon-xr-posthoc-player\\node_modules\\@intlayer\\core\\dist\\cjs\\markdown\\index.cjs'),
  r = require('E:\\NeilRomblon\\Projects\\neon-xr-posthoc-player\\node_modules\\@intlayer\\core\\dist\\cjs\\transpiler\\index.cjs'),
  n = require('E:\\NeilRomblon\\Projects\\neon-xr-posthoc-player\\node_modules\\@intlayer\\core\\dist\\cjs\\utils\\index.cjs'),
  h = () => o.default,
  q = o.default.internationalization.locales,
  w = o.default.internationalization.requiredLocales,
  T = o.default.internationalization.defaultLocale,
  F = o.default.editor
Object.defineProperty(exports, 'ALL_LOCALES', {
  enumerable: !0,
  get: function () {
    return v.ALL_LOCALES
  },
})
...
Object.defineProperty(exports, 'LocaleStorageClient', {
  enumerable: !0,
  get: function () {
    return n.LocaleStorageClient
  },
})
Object.defineProperty(exports, 'LocaleStorageServer', {
  enumerable: !0,
  get: function () {
    return n.LocaleStorageServer
  },
})
...
exports.configuration = o.default
...
Object.defineProperty(exports, 'getDictionary', {
  enumerable: !0,
  get: function () {
    return i.getDictionary
  },
})
Object.defineProperty(exports, 'getEnumeration', {
  enumerable: !0,
  get: function () {
    return i.getEnumeration
  },
})
...
Object.defineProperty(exports, 'getHTMLTextDir', {
  enumerable: !0,
  get: function () {
    return e.getHTMLTextDir
  },
})
Object.defineProperty(exports, 'getIntlayer', {
  enumerable: !0,
  get: function () {
    return i.getIntlayer
  },
})
...
Object.defineProperty(exports, 'localeDetector', {
  enumerable: !0,
  get: function () {
    return e.localeDetector
  },
})
Object.defineProperty(exports, 'localeFlatMap', {
  enumerable: !0,
  get: function () {
    return e.localeFlatMap
  },
})
...
Object.defineProperty(exports, 'localeRecord', {
  enumerable: !0,
  get: function () {
    return e.localeRecord
  },
})
Object.defineProperty(exports, 'localeResolver', {
  enumerable: !0,
  get: function () {
    return e.localeResolver
  },
})
exports.locales = q
